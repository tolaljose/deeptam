...
def adjust_intrinsics(view, K_new, width_new, height_new):
    ...
    3. adjust_intrinsics():
        ...
        - return: A View tuple with adjusted image, depth and intrinsics
        - functionality:
    """
    # original parameters
    fx = view.K[0, 0]
    ...
    if not view.depth is None:
        ...
        depth_resize = resize(depth_resize, (height_resize, width_resize), 0, mode='constant',
                              anti_aliasing=None) * max_depth
    else:
        depth_resize = None
